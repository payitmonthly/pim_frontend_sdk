    ...
    banner.innerHTML = `
      <div class="${uid}-banner-left-group">
        <div class="${uid}-banner-icon">
          <img src="https://storage.googleapis.com/payitmonthly/Public/SDK-FE/General/V1/intad.png" alt="" />
        </div>
      ...
      <div class="${uid}-logo-badge">
        <img src="https://storage.googleapis.com/payitmonthly/Public/SDK-FE/General/V1/fatlogo.png" alt="payitmonthly" />
      </div>
    `;
      ...
      <div class="${uid}-modal">
        ...
        <div class="${uid}-modal-left">
          <div class="${uid}-left-body">
            ...
            <div class="${uid}-left-swirl-1"><img src="https://storage.googleapis.com/payitmonthly/Public/SDK-FE/General/V1/swirl-3.svg" alt="" /></div>
            <div class="${uid}-left-swirl-2"><img src="https://storage.googleapis.com/payitmonthly/Public/SDK-FE/General/V1/swirl-4.svg" alt="" /></div>
            <div class="${uid}-left-logo">
              <img src="https://storage.googleapis.com/payitmonthly/Public/SDK-FE/General/V1/topleftiocn.png" alt="payitmonthly" />
            </div>
            <div class="${uid}-left-badges">
              <div class="${uid}-left-badge">
                <img class="${uid}-badge-icon" src="https://storage.googleapis.com/payitmonthly/Public/SDK-FE/General/V1/smallinticon.png" alt="" />
                Interest-free
              </div>
              <div class="${uid}-left-badge">
                <img class="${uid}-badge-icon" src="https://storage.googleapis.com/payitmonthly/Public/SDK-FE/General/V1/lightningicon.png" alt="" />
                Rapid decision
              </div>
            </div>
            ...
            <img class="${uid}-left-character" src="https://storage.googleapis.com/payitmonthly/Public/SDK-FE/General/V1/char.png" alt="" />
          </div>
          <div class="${uid}-trustpilot-bar">
            <img src="https://storage.googleapis.com/payitmonthly/Public/SDK-FE/General/V1/trustreview2.png" alt="Trustpilot 5 stars" />
          </div>
        </div>
